    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('customer', 'Customer'), ('beautician', 'Beautician'), ('admin', 'Admin')], default='customer', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_photo', models.ImageField(blank=True, null=True, upload_to='beautician_photos/')),
                ...
                ('skills', models.ManyToManyField(blank=True, related_name='beauticians', to='accounts.serviceskill')),
            ],
            options={
                'ordering': ['-id'],
            },
